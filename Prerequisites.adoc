...
This guide is for the users who are not using the educational cluster.
...
Click the result and `install` button. Install the operator with the default settings.
image:images/knative-settings.png[,700]
...
image:images/knative-serving-settings.png[,900]
