...
11. Access the sample app on browser again to update the pod. You will see that the version is updated to newer Open Liberty from 23.0.0.3.
+
...
13. Access the sample app on browser again and try refreshing the page several times. It will change the versions from time to time. This ensures 50% of the traffic is assigned to the first revision and the other to the second revision.
...
10. Access the sample app on browser again to update the pod. You will see that the version is updated to newer Open Liberty from 23.0.0.3.
+
image:images/sample-app-page-new.png[,800]
