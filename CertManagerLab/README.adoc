...
[source,sh]
----
oc get secret certificate-liberty-app-svc-tls-cm -n $NAMESPACE
...
----
NAME                                 TYPE                DATA   AGE
certificate-liberty-app-svc-tls-cm   kubernetes.io/tls   3      37s
NAME              READY   STATUS                AGE
olo-ca-issuer     True    Signing CA verified   49s
olo-self-signed   True                          49s
----
